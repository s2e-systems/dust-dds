...
void test_participant_lifecycle(void)
{
    ...
    DDS_ReturnCode result = DDS_DomainParticipantFactory_delete_participant(
        factory,
        participant);
    ...
    DDS_DomainParticipantQos qos = DDS_DomainParticipant_qos_default();
    ...
    DDS_Publisher *publisher = DDS_DomainParticipant_create_publisher(participant, NULL, NULL, 0);
    ...
    publisher = DDS_DomainParticipant_create_publisher(participant, &pub_qos, NULL, 0);
    TEST_ASSERT_NOT_NULL(publisher);
    result = DDS_DomainParticipant_delete_publisher(participant, publisher);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);

    DDS_Subscriber *subscriber = DDS_DomainParticipant_create_subscriber(participant, NULL, NULL, 0);
    ...
    subscriber = DDS_DomainParticipant_create_subscriber(participant, &sub_qos, NULL, 0);
    TEST_ASSERT_NOT_NULL(subscriber);
    result = DDS_DomainParticipant_delete_subscriber(participant, subscriber);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);
    ...
    DDS_DomainParticipant *looked_up = DDS_DomainParticipantFactory_lookup_participant(factory, 1);
    TEST_ASSERT_NOT_NULL(looked_up);

    result = DDS_DomainParticipantFactory_delete_participant(factory, looked_up);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);

    // After deleting, lookup should return NULL
    looked_up = DDS_DomainParticipantFactory_lookup_participant(factory, 1);
    ...
    result = DDS_DomainParticipantFactory_get_default_participant_qos(factory, &default_part_qos);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);
    ...
    result = DDS_DomainParticipantFactory_set_default_participant_qos(factory, &default_part_qos);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);

    // Verify default participant QoS was updated
    DDS_DomainParticipantQos default_part_qos2;
    result = DDS_DomainParticipantFactory_get_default_participant_qos(factory, &default_part_qos2);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);
    TEST_ASSERT_FALSE(default_part_qos2.entity_factory.autoenable_created_entities);

    // Restore to standard default QoS
    result = DDS_DomainParticipantFactory_set_default_participant_qos(factory, NULL);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);

    // Test factory QoS
    DDS_DomainParticipantFactoryQos factory_qos;
    result = DDS_DomainParticipantFactory_get_qos(factory, &factory_qos);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);
    TEST_ASSERT_TRUE(factory_qos.entity_factory.autoenable_created_entities);

    factory_qos.entity_factory.autoenable_created_entities = false;
    result = DDS_DomainParticipantFactory_set_qos(factory, &factory_qos);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);

    // Verify factory QoS updated
    DDS_DomainParticipantFactoryQos factory_qos2;
    result = DDS_DomainParticipantFactory_get_qos(factory, &factory_qos2);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);
    TEST_ASSERT_FALSE(factory_qos2.entity_factory.autoenable_created_entities);

    // Restore factory QoS to default
    DDS_DomainParticipantFactoryQos default_factory_qos = DDS_DomainParticipantFactory_qos_default();
    result = DDS_DomainParticipantFactory_set_qos(factory, &default_factory_qos);
    TEST_ASSERT_EQUAL_INT(DDS_RETCODE_OK, result);
}
