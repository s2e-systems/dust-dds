...
fn write_docs(pyi_file: &mut fs::File, attrs: &[Attribute]) {
...
fn write_default_value(pyi_file: &mut fs::File, field_ident: &Ident, attrs: &[Attribute]) {
    for attr in attrs.iter() {
