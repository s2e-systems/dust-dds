...
int main(int argc, char *argv[])
{
	...
	const dds_entity_t topic = dds_create_topic(participant, &interoperability_test_VariantUnion_desc, topic_name, NULL /*qos*/, NULL /*listener*/);
	if (topic < 0)
	{
	...
	samples[0] = interoperability_test_VariantUnion__alloc();
