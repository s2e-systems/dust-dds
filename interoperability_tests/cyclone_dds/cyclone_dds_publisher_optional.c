...
int main(int argx, char *argv[])
{
	...
	const dds_entity_t topic = dds_create_topic(participant, &interoperability_test_Optional_desc, topic_name, NULL /*qos*/, NULL /*listener*/);
	if (topic < 0)
	{
	...
	interoperability_test_Optional data = {
        .maybe_string = "Hello World!",
        .maybe_uint8 = NULL,
        .maybe_double = &(double){12345.6789},
        .maybe_array = NULL,
        .maybe_sequence = &(dds_sequence_float){
            ._maximum = UINT32_MAX,
            ._length = 3,
            ._buffer = (float[]){-FLT_MAX, 0.0, FLT_MAX},
            ._release = false
        }
    };
