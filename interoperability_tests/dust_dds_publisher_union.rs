...
pub mod interoperability {
    pub mod test {
        ...
        #[derive(DdsType, Debug, Clone, PartialEq)]
        #[dust_dds(name = "interoperability::test::UnionType", switch(UnionDescriptor))]
        pub enum UnionType {
            #[dust_dds(case = UnionDescriptor::None)]
            None,
            #[dust_dds(case = UnionDescriptor::Boolean)]
            Boolean(bool),
            #[dust_dds(case = UnionDescriptor::Byte)]
            Byte(u8),
            #[dust_dds(case = UnionDescriptor::Int16)]
            Int16(i16),
            #[dust_dds(case = UnionDescriptor::Int32)]
            Int32(i32),
            #[dust_dds(case = UnionDescriptor::Int64)]
            Int64(i64),
            #[dust_dds(case = UnionDescriptor::UInt16)]
            UInt16(u16),
            #[dust_dds(case = UnionDescriptor::UInt32)]
            UInt32(u32),
            #[dust_dds(case = UnionDescriptor::UInt64)]
            UInt64(u64),
            #[dust_dds(case = UnionDescriptor::Float32)]
            Float32(f32),
            #[dust_dds(case = UnionDescriptor::Float64)]
            Float64(f64),
            #[dust_dds(case = UnionDescriptor::Int8)]
            Int8(i8),
            #[dust_dds(case = UnionDescriptor::UInt8)]
            UInt8(u8),
            #[dust_dds(case = UnionDescriptor::Char8)]
            Char8(u8),
            #[dust_dds(case = UnionDescriptor::String8)]
            String8(String),
            #[dust_dds(case = UnionDescriptor::Enum)]
            Enum(VariantEnum),
            #[dust_dds(case = UnionDescriptor::Structure)]
            Structure(VariantStructure),
            #[dust_dds(case = UnionDescriptor::Union)]
            Union(VariantUnion),
            #[dust_dds(case = UnionDescriptor::Sequence)]
            Sequence(Vec<String>),
            #[dust_dds(case = UnionDescriptor::Array)]
            Array([f64; 3]),
        }
        ...
        #[derive(DdsType, Debug, Clone, PartialEq, Eq)]
        #[dust_dds(name = "interoperability::test::VariantUnion", switch(u16))]
        ...
        impl VariantUnion {
            pub fn new_random() -> Self {
                match crate::random_value(3) {
                    0 => match crate::random_value(3) {
                        0 => Self::X10(u8::MAX / 2),
                        1 => Self::X20(u8::MAX / 2),
                        2 => Self::X30(u8::MAX / 2),
                        _ => unreachable!(),
                    },
                    1 => match crate::random_value(3) {
                        0 => Self::Y100(u16::MAX / 2),
                        1 => Self::Y200(u16::MAX / 2),
                        2 => Self::Y300(u16::MAX / 2),
                        _ => unreachable!(),
                    },
                    2 => match crate::random_value(3) {
                        0 => Self::Z1000(u32::MAX / 2),
                        1 => Self::Z2000(u32::MAX / 2),
                        2 => Self::Z3000(u32::MAX / 2),
                        _ => unreachable!(),
                    },
                    _ => unreachable!(),
                }
