use rust_rtps::messages::submessages::{Submessage, SubmessageHeader, RtpsSubmessage};
use rust_rtps::messages::types::{SubmessageKind, SubmessageFlag};
...
mod tests {
    ...
    use rust_rtps::messages::submessages::Data;
