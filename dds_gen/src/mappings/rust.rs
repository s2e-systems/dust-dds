...
pub fn struct_def(def: idl::Struct) -> impl Iterator<Item = String> {
    [
        "#[derive(Debug, serde::Deserialize, serde::Serialize, dust_dds::topic_definition::type_support::DdsType, dust_dds::topic_definition::type_support::DdsKey, dust_dds::topic_definition::type_support::DdsRepresentation)]\n".to_string(),
        format!("pub struct {} {{\n", def.name),
    ]
        .into_iter()
        .chain(
