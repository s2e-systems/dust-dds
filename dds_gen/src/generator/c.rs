...
impl<'a> CGenerator<'a> {
    ...
    fn struct_def(&mut self, pair: IdlPair<'a>) {
        ...
        self.writer.push_str("            };\n");
        self.writer.push_str("            DDS_DynamicTypeBuilder* builder = DDS_dynamic_type_builder_factory_create_type(&descriptor);\n");
