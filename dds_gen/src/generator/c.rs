...
impl<'a> CGenerator<'a> {
        ...
        for annotation_appl in inner_pairs.filter(|p| p.as_rule() == Rule::annotation_appl) {
            ...
            if let Some(scoped_name) = inner.clone().find(|p| p.as_rule() == Rule::scoped_name) {
                if let Some(ident) = scoped_name.into_inner().next() {
                    match ident.as_str() {
                        "appendable" => return Some("DDS_EXTENSIBILITY_KIND_APPENDABLE"),
                        "mutable" => return Some("DDS_EXTENSIBILITY_KIND_MUTABLE"),
                        "final" => return Some("DDS_EXTENSIBILITY_KIND_FINAL"),
                        _ => {}
                    }
                }
            }
    ...
    fn struct_def(&mut self, pair: IdlPair<'a>) {
        ...
        // --- get_type() ---
        self.writer
            .push_str("\n    static inline const DDS_DynamicType* ");
        self.writer.push_str(&prefixed_struct_name);
        self.writer.push_str("_get_type(void) {\n");
        self.writer
            .push_str("        static const DDS_DynamicType* type = NULL;\n");
        self.writer.push_str("        if (type == NULL) {\n");
        let ext = Self::get_extensibility_annotation(inner_pairs.clone())
            .unwrap_or("DDS_EXTENSIBILITY_KIND_FINAL");

        self.writer
            .push_str("            DDS_TypeDescriptor descriptor = {\n");
        self.writer
            .push_str("                .kind = DDS_TYPE_KIND_STRUCTURE,\n");
        ...
        self.writer.push_str("            };\n");
        self.writer.push_str("            DDS_DynamicTypeBuilder* builder = DDS_DynamicTypeBuilderFactory_create_type(&descriptor);\n");
        ...
        // Emit add_member calls using DDS_MemberDescriptor
        for (member_id, type_spec, field_name, is_key, is_optional) in &members {
            ...
            self.writer
                .push_str("                DDS_MemberDescriptor member = {\n");
            self.writer.push_str(&format!(
                "                    .name = \"{}\",\n",
                field_name
            ));
        ...
        self.writer
            .push_str("            type = DDS_DynamicTypeBuilder_build(builder);\n");
        self.writer.push_str("        }\n");
            ...
            match leaf_rule {
                Rule::boolean_type => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_boolean_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_boolean_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::char_type => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_char8_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_char8_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::wide_char_type => {
                    create_sample_code.push_str(&format!(
                        "        {{\n            char temp;\n            DDS_DynamicData_get_char8_value(src, {}, &temp);\n            sample.{} = (wchar_t)temp;\n        }}\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_char8_value(sample, {}, (char)src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::octet_type | Rule::unsigned_tiny_int => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_uint8_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_uint8_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::signed_tiny_int => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_int8_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_int8_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::signed_short_int => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_int16_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_int16_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::unsigned_short_int => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_uint16_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_uint16_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::signed_long_int => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_int32_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_int32_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::unsigned_long_int => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_uint32_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_uint32_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::signed_longlong_int => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_int64_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_int64_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::unsigned_longlong_int => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_uint64_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_uint64_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                }
                Rule::floating_pt_type => {
                    if leaf_str == "float" {
                        create_sample_code.push_str(&format!(
                            "        DDS_DynamicData_get_float32_value(src, {}, &sample.{});\n",
                            member_id, field_name
                        ));
                        create_dynamic_sample_code.push_str(&format!(
                            "            DDS_DynamicData_set_float32_value(sample, {}, src->{});\n",
                            member_id, field_name
                        ));
                    } else if leaf_str == "double" {
                        create_sample_code.push_str(&format!(
                            "        DDS_DynamicData_get_float64_value(src, {}, &sample.{});\n",
                            member_id, field_name
                        ));
                        create_dynamic_sample_code.push_str(&format!(
                            "            DDS_DynamicData_set_float64_value(sample, {}, src->{});\n",
                            member_id, field_name
                        ));
                    } else {
                ...
                Rule::string_type => {
                    create_sample_code.push_str(&format!(
                        "        DDS_DynamicData_get_string_value(src, {}, &sample.{});\n",
                        member_id, field_name
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            DDS_DynamicData_set_string_value(sample, {}, src->{});\n",
                        member_id, field_name
                    ));
                ...
                _ => {
                    ...
                    create_sample_code.push_str(&format!(
                        "        {{\n            DDS_DynamicData* member_data = NULL;\n            DDS_DynamicData_get_complex_value(src, {}, &member_data);\n            if (member_data != NULL) {{\n                sample.{} = {}_create_sample(member_data);\n                DDS_DynamicData_free(member_data);\n            }}\n        }}\n",
                        member_id, field_name, resolved_leaf
                    ));
                    create_dynamic_sample_code.push_str(&format!(
                        "            {{\n                DDS_DynamicData* member_data = {}_create_dynamic_sample(&src->{});\n                DDS_DynamicData_set_complex_value(sample, {}, member_data);\n                DDS_DynamicData_free(member_data);\n            }}\n",
        ...
        self.writer.push_str(&format!(
            "\n    static inline struct {} {}_create_sample(DDS_DynamicData* src) {{\n        struct {} sample;\n        memset(&sample, 0, sizeof(sample));\n{}        return sample;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name, create_sample_code
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_DynamicData* {}_create_dynamic_sample(const struct {}* src) {{\n        DDS_DynamicData* sample = DDS_DynamicData_create({}_get_type());\n        if (sample != NULL) {{\n{}        }}\n        return sample;\n    }}\n",
        ...
        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataWriter_write(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_write(writer, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataWriter_write_w_timestamp(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle, struct DDS_Time_t source_timestamp) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_write_w_timestamp(writer, sample, handle, source_timestamp);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataWriter_register_instance(DDS_DataWriter* writer, const struct {}* data, DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || data == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_register_instance(writer, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataWriter_register_instance_w_timestamp(DDS_DataWriter* writer, const struct {}* data, struct DDS_Time_t source_timestamp, DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || data == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_register_instance_w_timestamp(writer, sample, source_timestamp, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataWriter_unregister_instance(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_unregister_instance(writer, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataWriter_unregister_instance_w_timestamp(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle, struct DDS_Time_t source_timestamp) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_unregister_instance_w_timestamp(writer, sample, handle, source_timestamp);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataWriter_dispose(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_dispose(writer, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataWriter_dispose_w_timestamp(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle, struct DDS_Time_t source_timestamp) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_dispose_w_timestamp(writer, sample, handle, source_timestamp);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataWriter_get_key_value(DDS_DataWriter* writer, struct {}* key_holder, const DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || key_holder == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(key_holder);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_get_key_value(writer, sample, handle);\n        if (result == DDS_RETCODE_OK) {{\n            *key_holder = {}_create_sample(sample);\n        }}\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataWriter_lookup_instance(DDS_DataWriter* writer, const struct {}* key_holder, DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || key_holder == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(key_holder);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_lookup_instance(writer, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_read(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_read(reader, samples, sample_infos, max_samples, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_take(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_take(reader, samples, sample_infos, max_samples, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_read_next_sample(DDS_DataReader* reader, struct {}* data_value, struct DDS_SampleInfo* sample_info) {{\n        if (reader == NULL || data_value == NULL || sample_info == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = NULL;\n        DDS_ReturnCode result = DDS_DataReader_read_next_sample(reader, &sample, sample_info);\n        if (result == DDS_RETCODE_OK) {{\n            if (sample != NULL) {{\n                *data_value = {}_create_sample(sample);\n                DDS_DynamicData_free(sample);\n            }}\n        }}\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_take_next_sample(DDS_DataReader* reader, struct {}* data_value, struct DDS_SampleInfo* sample_info) {{\n        if (reader == NULL || data_value == NULL || sample_info == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = NULL;\n        DDS_ReturnCode result = DDS_DataReader_take_next_sample(reader, &sample, sample_info);\n        if (result == DDS_RETCODE_OK) {{\n            if (sample != NULL) {{\n                *data_value = {}_create_sample(sample);\n                DDS_DynamicData_free(sample);\n            }}\n        }}\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_read_instance(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, const DDS_InstanceHandle_t* a_handle, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || a_handle == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_read_instance(reader, samples, sample_infos, max_samples, a_handle, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_take_instance(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, const DDS_InstanceHandle_t* a_handle, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || a_handle == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_take_instance(reader, samples, sample_infos, max_samples, a_handle, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_read_next_instance(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, const DDS_InstanceHandle_t* previous_handle, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || previous_handle == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_read_next_instance(reader, samples, sample_infos, max_samples, previous_handle, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_take_next_instance(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, const DDS_InstanceHandle_t* previous_handle, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || previous_handle == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_take_next_instance(reader, samples, sample_infos, max_samples, previous_handle, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_return_loan(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos) {{\n        return DDS_DataReader_return_loan(reader, NULL, sample_infos);\n    }}\n",
            prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_get_key_value(DDS_DataReader* reader, struct {}* key_holder, const DDS_InstanceHandle_t* handle) {{\n        if (reader == NULL || key_holder == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(key_holder);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_get_key_value(reader, sample, handle);\n        if (result == DDS_RETCODE_OK) {{\n            *key_holder = {}_create_sample(sample);\n        }}\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode DDS_{}DataReader_lookup_instance(DDS_DataReader* reader, const struct {}* key_holder, DDS_InstanceHandle_t* handle) {{\n        if (reader == NULL || key_holder == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(key_holder);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_lookup_instance(reader, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));
    }
    ...
    fn get_dynamic_type_expr(&self, type_spec: IdlPair<'a>) -> String {
        ...
        loop {
            match current.as_rule() {
                ...
                Rule::boolean_type => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_BOOLEAN)".to_string();
                }
                Rule::char_type => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_CHAR8)".to_string();
                }
                Rule::wide_char_type => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_CHAR8)".to_string();
                }
                Rule::octet_type => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_UINT8)".to_string();
                }
                Rule::signed_tiny_int => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_INT8)".to_string();
                }
                Rule::unsigned_tiny_int => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_UINT8)".to_string();
                }
                Rule::signed_short_int => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_INT16)".to_string();
                }
                Rule::unsigned_short_int => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_UINT16)".to_string();
                }
                Rule::signed_long_int => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_INT32)".to_string();
                }
                Rule::unsigned_long_int => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_UINT32)".to_string();
                }
                Rule::signed_longlong_int => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_INT64)".to_string();
                }
                Rule::unsigned_longlong_int => {
                    return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_UINT64)".to_string();
                }
                Rule::floating_pt_type => match current.as_str() {
                    "float" => {
                        return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_FLOAT32)"
                            .to_string();
                    }
                    "double" => {
                        return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_FLOAT64)"
                            .to_string();
                    }
                    "long double" => {
                        return "DDS_DynamicType_get_primitive_type(DDS_TYPE_KIND_FLOAT128)"
                            .to_string();
                    }
                ...
                Rule::string_type | Rule::wide_string_type => {
                    ...
                    return format!("DDS_DynamicType_create_string_type({})", bound);
                }
                _ => {
                    let resolved = self.resolve_type(current.as_str());
                    return format!("(DDS_DynamicType*){}_get_type()", resolved);
                }
            }
        }
    }
