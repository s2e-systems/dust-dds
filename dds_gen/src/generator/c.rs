...
impl<'a> CGenerator<'a> {
    ...
    fn struct_def(&mut self, pair: IdlPair<'a>) {
        ...
        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataWriter_write(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_write(writer, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataWriter_write_w_timestamp(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle, struct DDS_Time_t source_timestamp) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_write_w_timestamp(writer, sample, handle, source_timestamp);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataWriter_register_instance(DDS_DataWriter* writer, const struct {}* data, DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || data == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_register_instance(writer, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataWriter_register_instance_w_timestamp(DDS_DataWriter* writer, const struct {}* data, struct DDS_Time_t source_timestamp, DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || data == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_register_instance_w_timestamp(writer, sample, source_timestamp, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataWriter_unregister_instance(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_unregister_instance(writer, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataWriter_unregister_instance_w_timestamp(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle, struct DDS_Time_t source_timestamp) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_unregister_instance_w_timestamp(writer, sample, handle, source_timestamp);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataWriter_dispose(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_dispose(writer, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataWriter_dispose_w_timestamp(DDS_DataWriter* writer, const struct {}* data, const DDS_InstanceHandle_t* handle, struct DDS_Time_t source_timestamp) {{\n        if (writer == NULL || data == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(data);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_dispose_w_timestamp(writer, sample, handle, source_timestamp);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataWriter_get_key_value(DDS_DataWriter* writer, struct {}* key_holder, const DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || key_holder == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(key_holder);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_get_key_value(writer, sample, handle);\n        if (result == DDS_RETCODE_OK) {{\n            *key_holder = {}_create_sample(sample);\n        }}\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataWriter_lookup_instance(DDS_DataWriter* writer, const struct {}* key_holder, DDS_InstanceHandle_t* handle) {{\n        if (writer == NULL || key_holder == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(key_holder);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataWriter_lookup_instance(writer, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_read(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_read(reader, samples, sample_infos, max_samples, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_take(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_take(reader, samples, sample_infos, max_samples, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_read_next_sample(DDS_DataReader* reader, struct {}* data_value, struct DDS_SampleInfo* sample_info) {{\n        if (reader == NULL || data_value == NULL || sample_info == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = NULL;\n        DDS_ReturnCode result = DDS_DataReader_read_next_sample(reader, &sample, sample_info);\n        if (result == DDS_RETCODE_OK) {{\n            if (sample != NULL) {{\n                *data_value = {}_create_sample(sample);\n                DDS_DynamicData_free(sample);\n            }}\n        }}\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_take_next_sample(DDS_DataReader* reader, struct {}* data_value, struct DDS_SampleInfo* sample_info) {{\n        if (reader == NULL || data_value == NULL || sample_info == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = NULL;\n        DDS_ReturnCode result = DDS_DataReader_take_next_sample(reader, &sample, sample_info);\n        if (result == DDS_RETCODE_OK) {{\n            if (sample != NULL) {{\n                *data_value = {}_create_sample(sample);\n                DDS_DynamicData_free(sample);\n            }}\n        }}\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_read_instance(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, const DDS_InstanceHandle_t* a_handle, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || a_handle == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_read_instance(reader, samples, sample_infos, max_samples, a_handle, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_take_instance(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, const DDS_InstanceHandle_t* a_handle, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || a_handle == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_take_instance(reader, samples, sample_infos, max_samples, a_handle, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_read_next_instance(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, const DDS_InstanceHandle_t* previous_handle, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || previous_handle == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_read_next_instance(reader, samples, sample_infos, max_samples, previous_handle, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_take_next_instance(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos, int32_t max_samples, const DDS_InstanceHandle_t* previous_handle, DDS_SampleStateMask sample_states, DDS_ViewStateMask view_states, DDS_InstanceStateMask instance_states, int32_t* received_samples) {{\n        if (reader == NULL || data_values == NULL || previous_handle == NULL || received_samples == NULL || max_samples <= 0) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData** samples = (DDS_DynamicData**)calloc(max_samples, sizeof(DDS_DynamicData*));\n        if (samples == NULL) {{\n            return DDS_RETCODE_OUT_OF_RESOURCES;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_take_next_instance(reader, samples, sample_infos, max_samples, previous_handle, sample_states, view_states, instance_states, received_samples);\n        if (result == DDS_RETCODE_OK) {{\n            for (int32_t i = 0; i < *received_samples; i++) {{\n                if (samples[i] != NULL) {{\n                    data_values[i] = {}_create_sample(samples[i]);\n                    DDS_DynamicData_free(samples[i]);\n                }}\n            }}\n        }}\n        free(samples);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_return_loan(DDS_DataReader* reader, struct {}* data_values, struct DDS_SampleInfo* sample_infos) {{\n        return DDS_DataReader_return_loan(reader, NULL, sample_infos);\n    }}\n",
            prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_get_key_value(DDS_DataReader* reader, struct {}* key_holder, const DDS_InstanceHandle_t* handle) {{\n        if (reader == NULL || key_holder == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(key_holder);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_get_key_value(reader, sample, handle);\n        if (result == DDS_RETCODE_OK) {{\n            *key_holder = {}_create_sample(sample);\n        }}\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));

        self.writer.push_str(&format!(
            "\n    static inline DDS_ReturnCode {}DataReader_lookup_instance(DDS_DataReader* reader, const struct {}* key_holder, DDS_InstanceHandle_t* handle) {{\n        if (reader == NULL || key_holder == NULL || handle == NULL) {{\n            return DDS_RETCODE_BAD_PARAMETER;\n        }}\n        DDS_DynamicData* sample = {}_create_dynamic_sample(key_holder);\n        if (sample == NULL) {{\n            return DDS_RETCODE_ERROR;\n        }}\n        DDS_ReturnCode result = DDS_DataReader_lookup_instance(reader, sample, handle);\n        DDS_DynamicData_free(sample);\n        return result;\n    }}\n",
            prefixed_struct_name, prefixed_struct_name, prefixed_struct_name
        ));
    }
