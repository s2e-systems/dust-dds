...
mod tests {
    ...
    fn test_builtin_endpoint_set_participant_announcer() {
        ...
        assert_eq!(
            BuiltInEndpointSet::new(1)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_ANNOUNCER),
            true
        );
        assert_eq!(
            BuiltInEndpointSet::new(16)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_ANNOUNCER),
            false
        );
        assert_eq!(
            BuiltInEndpointSet::new(15)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_ANNOUNCER),
            true
        );
        assert_eq!(
    ...
    fn test_builtin_endpoint_set_participant_detector() {
        assert_eq!(
            BuiltInEndpointSet::new(0)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_DETECTOR),
            false
        );
        assert_eq!(
            BuiltInEndpointSet::new(2)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_DETECTOR),
            true
        );
        assert_eq!(
    ...
    fn test_builtin_endpoint_set_subscriptions_announcer() {
        ...
        assert_eq!(
            BuiltInEndpointSet::new(32)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_SUBSCRIPTIONS_ANNOUNCER),
            false
        );
        assert_eq!(
            BuiltInEndpointSet::new(31)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_SUBSCRIPTIONS_ANNOUNCER),
            true
        );
    }
    ...
    fn test_builtin_endpoint_participant_message_data_writer() {
        assert_eq!(
            BuiltInEndpointSet::new(0)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_MESSAGE_DATA_WRITER),
            false
        );
        assert_eq!(
            BuiltInEndpointSet::new(1024)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_MESSAGE_DATA_WRITER),
            true
        );
        assert_eq!(
            BuiltInEndpointSet::new(1023)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_MESSAGE_DATA_WRITER),
            false
        );
        assert_eq!(
            BuiltInEndpointSet::new(2047)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_MESSAGE_DATA_WRITER),
            true
        );
    }
    ...
    fn test_builtin_endpoint_participant_message_data_reader() {
        assert_eq!(
            BuiltInEndpointSet::new(0)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_MESSAGE_DATA_READER),
            false
        );
        assert_eq!(
            BuiltInEndpointSet::new(2048)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_PARTICIPANT_MESSAGE_DATA_READER),
            true
        );
        assert_eq!(
    ...
    fn test_builtin_endpoint_topics_announcer() {
        ...
        assert_eq!(
            BuiltInEndpointSet::new(268435456)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_TOPICS_ANNOUNCER),
            true
        );
        assert_eq!(
            BuiltInEndpointSet::new(268435455)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_TOPICS_ANNOUNCER),
            false
        );
        assert_eq!(
            BuiltInEndpointSet::new(536870911)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_TOPICS_ANNOUNCER),
            true
        );
    }
    ...
    fn test_builtin_endpoint_topics_detector() {
        ...
        assert_eq!(
            BuiltInEndpointSet::new(536870912)
        ...
        assert_eq!(
            BuiltInEndpointSet::new(1073741823)
                .has(BuiltInEndpointSet::BUILTIN_ENDPOINT_TOPICS_DETECTOR),
            true
        );
    }
