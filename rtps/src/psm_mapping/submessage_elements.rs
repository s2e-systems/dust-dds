...
// pub fn serialize_locator(locator: &types::Locator, writer: &mut impl std::io::Write, endianness: Endianness) -> UdpPsmMappingResult<()> {
...
// pub fn deserialize_locator(bytes: &[u8], endianness: Endianness) -> UdpPsmMappingResult<types::Locator> {
...
//         parameter_list.parameter.push(Parameter::new(parameter_id, value));
//     }
