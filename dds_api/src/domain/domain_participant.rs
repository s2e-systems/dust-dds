    ...
    Entity<Qos = DomainParticipantQos, Listener = Box<dyn DomainParticipantListener>>
{
    ...
    fn ignore_participant(&self, handle: InstanceHandle) -> ReturnCode<()>;
    ...
    /// Possible error codes returned in addition to the standard ones: OUT_OF_RESOURCES.
    fn ignore_topic(&self, handle: InstanceHandle) -> ReturnCode<()>;
    ...
    /// Possible error codes returned in addition to the standard ones: OUT_OF_RESOURCES.
    fn ignore_publication(&self, handle: InstanceHandle) -> ReturnCode<()>;
    ...
    /// Possible error codes returned in addition to the standard ones: OUT_OF_RESOURCES.
    fn ignore_subscription(&self, handle: InstanceHandle) -> ReturnCode<()>;
    ...
    fn get_discovered_topics(&self, topic_handles: &mut [InstanceHandle]) -> ReturnCode<()>;
