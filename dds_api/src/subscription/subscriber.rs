use crate::types::{ReturnCode, InstanceHandle, ReturnCodes};
...
use crate::infrastructure::qos::{TopicQos, SubscriberQos, DataReaderQos};
...
pub trait Subscriber : DomainEntity<Qos=SubscriberQos, Listener=Box<dyn SubscriberListener>> {
    ...
    fn get_datareaders<T: DDSType>(
        &self,
        _readers: &mut [&mut dyn DataReader<T>],
