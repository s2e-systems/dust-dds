...
pub trait RTPSHistoryCache {
    type CacheChange: RTPSCacheChange;
    ...
    fn remove_change(&mut self, seq_num: &<Self::CacheChange as RTPSCacheChange>::SequenceNumber);

    fn get_change(
        &self,
        seq_num: &<Self::CacheChange as RTPSCacheChange>::SequenceNumber,
    ...
    fn get_seq_num_min(&self) -> Option<&<Self::CacheChange as RTPSCacheChange>::SequenceNumber>;
    ...
    fn get_seq_num_max(&self) -> Option<&<Self::CacheChange as RTPSCacheChange>::SequenceNumber>;
}
