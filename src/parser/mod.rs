...
type FragmentNumberSet = Vec<(FragmentNumber, bool)>;
    ...
    fn test_parse_heartbeat_frag_submessage() {
        {
            ...
            assert_eq!(heartbeat_frag.reader_id, [0x10,0x11,0x12,0x13,]);
            assert_eq!(heartbeat_frag.writer_id, [0x26,0x25,0x24,0x23,]);
    ...
    fn test_parse_info_reply_submessage() {
        {
            ...
            {
                let info_reply_big_endian = parse_info_reply_submessage(&submessage_big_endian, &2).unwrap();
                ...
                assert_eq!(info_reply_big_endian.unicast_locator_list[0].address, [0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10,]);
                ...
                assert_eq!(info_reply_big_endian.unicast_locator_list[1].address, [0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,]);
                ...
                assert_eq!(multicast_locator_list[0].address, [0x01, 0x02, 0x03, 0x04, 0x09, 0x0A, 0x0B, 0x0C, 0x05, 0x06, 0x07, 0x08, 0x0D, 0x0E, 0x0F, 0x10,]);
            }

            {
                let info_reply_big_endian = parse_info_reply_submessage(&submessage_big_endian, &0).unwrap();
                assert_eq!(info_reply_big_endian.unicast_locator_list.len(), 2);
...

        {
            ...
            {
                let info_reply_little_endian = parse_info_reply_submessage(&submessage_little_endian, &3).unwrap();
                ...
                assert_eq!(info_reply_little_endian.unicast_locator_list[0].address, [0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10,]);
                ...
                assert_eq!(info_reply_little_endian.unicast_locator_list[1].address, [0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F, 0x10, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08,]);
            ...
            {
                let info_reply_little_endian = parse_info_reply_submessage(&submessage_little_endian, &1).unwrap();
                assert_eq!(info_reply_little_endian.unicast_locator_list.len(), 2);
