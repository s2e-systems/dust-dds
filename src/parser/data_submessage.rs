...
impl Serialize for Data {
        ...
        S: Serializer
    {
        ...
        state.serialize_field("InlineQoS", self.inline_qos())?;
...
mod tests {
    ...
    fn test_serialize_data_message() {
        ...
        let data = Data::new(
            ...
            1, /*writer_sn*/
            None, /*inline_qos*/
            Payload::Data(vec![1,2,3]) /*serialized_payload*/);
        
        
        println!("Data: {:x?}", cdr::ser::serialize_data::<_,_,LittleEndian>(&data, Infinite).unwrap());
    }
}
