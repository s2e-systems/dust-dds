...
impl From<GUID> for crate::types::InstanceHandle {
...
impl TryFrom<crate::types::InstanceHandle> for GUID {
    type Error = ();
    fn try_from(value: crate::types::InstanceHandle) -> Result<Self, Self::Error> {
...
mod tests {
    ...
    fn guid_to_instance_handle() {
        ...
        let entity_id = EntityId::new([200, 100, 5], constants::ENTITY_KIND_USER_DEFINED_READER_GROUP);
