...
impl Data {
    ...
    pub fn new(
        ...
        writer_sn: crate::types::SequenceNumber,
        inline_qos: Option<crate::types::ParameterList>,
        payload: Payload,) -> Self {
            ...
            let inline_qos = match inline_qos {
                ...
                None => crate::types::ParameterList::new(),
            };
    ...
    pub fn inline_qos(&self) -> &crate::types::ParameterList {
        &self.inline_qos
    }
    ...
    pub fn take_payload_and_qos(self) -> (submessage_elements::SerializedData, crate::types::ParameterList) {
...
impl Submessage for Data {
    ...
    fn is_valid(&self) -> bool {
        if self.writer_sn < 1 || self.writer_sn == crate::types::SEQUENCE_NUMBER_UNKNOWN {
...
mod tests {
    use super::*;
    use crate::rtps::types::constants::{ENTITYID_UNKNOWN, ENTITYID_SPDP_BUILTIN_PARTICIPANT_ANNOUNCER, };
    ...
    fn test_data_contructor() {
        let data = Data::new(
            ...
            1, 
            Some(crate::types::ParameterList::new()),
            Payload::Data(vec![])
        );
