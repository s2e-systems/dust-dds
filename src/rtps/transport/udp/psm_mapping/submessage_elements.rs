...
use crate::rtps::messages::submessages::submessage_elements::{Long, Short, ULong, UShort, Timestamp, GuidPrefix, EntityId, VendorId, ProtocolVersion, SequenceNumber, SequenceNumberSet, FragmentNumber, FragmentNumberSet, LocatorList, Count, SerializedData, ParameterList};
...
pub fn deserialize_parameter_list(bytes: &[u8], endianness: Endianness) -> UdpPsmMappingResult<ParameterList> {
    ...
    loop {
        ...
        parameter_list.parameter.push(crate::types::Parameter::new(parameter_id, value));
    }
