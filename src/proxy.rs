...
impl WriterProxy<'_>
{
    ...
    pub fn irrelevant_change_set(&self, a_seq_num : SequenceNumber) 
    {
        ...
        reader_cache_change.1.change_from_writer.is_relevant = false;
    }
    ...
    pub fn lost_changes_update(&self, first_available_seq_num : SequenceNumber)
    {
        ...
        {
            reader_cache_change.1.change_from_writer.status = ChangeFromWriterStatusKind::Lost;
        }
    }
    ...
    pub fn missing_changes_update(&self, last_available_seq_num : SequenceNumber)
    {
        ...
        {
            reader_cache_change.1.change_from_writer.status = ChangeFromWriterStatusKind::Missing;
        }
    }
