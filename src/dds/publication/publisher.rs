...
pub trait Publisher<T: DDSType> : DomainEntity<Qos=PublisherQos, Listener=Box<dyn PublisherListener>>{
    type Participant : DomainParticipant<T>;
    type Writer: DataWriter<T>;
