use crate::{dds::{domain::domain_participant::DomainParticipantNode, infrastructure::{entity::Entity, qos::TopicQos}}, types::{DDSType, ReturnCode}};
...
pub trait TopicDescription<T: DDSType> : Entity<Qos=TopicQos, Listener=Box<dyn TopicListener<T>>> {
