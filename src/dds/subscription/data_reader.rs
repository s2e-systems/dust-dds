...
use crate::infrastructure::qos::{DataReaderQos, SubscriberQos};
...
use super::SubscriberListener;

pub trait AnyDataReader{}

impl<T:DDSType> AnyDataReader for dyn DataReader<T> {}
...
pub trait DataReader<T: DDSType> : DomainEntity<Qos=DataReaderQos, Listener=Box<dyn DataReaderListener<T>>>{
