use crate::types::{ReturnCode, ReturnCodes, DDSType};
...
impl DomainParticipant {
    ...
    pub fn create_publisher(
        ...
        let rtps_publisher = self.0.create_publisher()?;
    ...
    pub fn create_subscriber(
        ...
        let rtps_subscriber = self.0.create_subscriber()?;
    ...
    pub fn create_topic<T:DDSType>(
        ...
        let rtps_topic = self.0.create_topic()?;
