use dust_dds::{
    ...
    xtypes::dynamic_type::{
        DynamicData, DynamicDataFactory, DynamicDataInsert, DynamicTypeBuilderFactory,
        ExtensibilityKind, MemberDescriptor, TryConstructKind, TypeDescriptor, TK_INT64,
        TK_STRUCTURE,
    },
};
...
//                     name: String::from("color"),
//                     id: 0,
//                     r#type: <String as DynamicDataInsert>::get_type(),
//                     default_value: String::new(),
//                     index: 0,
//                     label: Vec::new(),
//                     try_construct_kind: TryConstructKind::UseDefault,
...
//             data.set_int32_value(0, self.x).unwrap();
//             data
//         }
//     }
