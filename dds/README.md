...
```rust
    use dust_dds::{
        ...
        topic_definition::type_support::{DdsHasKey, DdsGetKey, DdsRepresentation},
    };

    use serde::{Deserialize, Serialize};

    #[derive(Deserialize, Serialize, DdsHasKey, DdsGetKey, DdsRepresentation)]
...
```rust
    ...
    #[derive(Debug, Deserialize, Serialize, DdsHasKey, DdsGetKey, DdsRepresentation)]
    struct HelloWorldType {
        #[key]
        id: u8,
        msg: String,
