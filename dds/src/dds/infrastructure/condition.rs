...
impl StatusCondition {
    ...
    pub fn get_enabled_statuses(&self) -> DdsResult<Vec<StatusKind>> {
        self.0
            .send_mail_and_await_reply_blocking(dds_status_condition::GetEnabledStatuses)
    }
    ...
    pub fn set_enabled_statuses(&self, mask: &[StatusKind]) -> DdsResult<()> {
        self.0
            .send_mail_and_await_reply_blocking(dds_status_condition::SetEnabledStatuses::new(mask.to_vec()))
    }
...
impl StatusCondition {
    ...
    pub fn get_trigger_value(&self) -> DdsResult<bool> {
        self.0
            .send_mail_and_await_reply_blocking(dds_status_condition::GetTriggerValue)
    }
}
