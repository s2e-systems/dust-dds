...
/// of the Data submessage when transmitting information about a published sample.
...
pub trait NewDdsSerialize {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()>;
}

impl NewDdsSerialize for bool {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_bool(*self)
    }
}

impl NewDdsSerialize for i8 {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_i8(*self)
    }
}

impl NewDdsSerialize for i16 {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_i16(*self)
    }
}

impl NewDdsSerialize for i32 {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_i32(*self)
    }
}

impl NewDdsSerialize for i64 {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_i64(*self)
    }
}

impl NewDdsSerialize for u8 {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_u8(*self)
    }
}

impl NewDdsSerialize for u16 {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_u16(*self)
    }
}

impl NewDdsSerialize for u32 {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_u32(*self)
    }
}

impl NewDdsSerialize for u64 {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_u64(*self)
    }
}

impl NewDdsSerialize for f32 {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_f32(*self)
    }
}

impl NewDdsSerialize for f64 {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_f64(*self)
    }
}

impl NewDdsSerialize for char {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_char(*self)
    }
}

impl NewDdsSerialize for str {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_str(self)
    }
}

impl NewDdsSerialize for String {
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
        serializer.serialize_str(self)
    }
}

impl<T> NewDdsSerialize for [T]
where
    T: NewDdsSerialize,
{
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
...
impl<T> NewDdsSerialize for Box<T>
where
    T: NewDdsSerialize,
{
    fn serialize(&self, serializer: &mut impl DdsSerializer) -> DdsResult<()> {
