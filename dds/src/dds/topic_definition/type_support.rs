...
pub use dust_dds_derive::{
    DdsBorrowKeyHolder, DdsDeserialize, DdsHasKey, DdsOwningKeyHolder, DdsSerialize, DdsType,
};
...
/// This trait implements the functionality required to serialize the information contained
/// in a data structure to be published.
///
