...
pub trait AnyDataWriterListener {
    fn trigger_on_liveliness_lost(&mut self, _the_writer: &DdsShared<UserDefinedDataWriter>);
    ...
    fn trigger_on_publication_matched(&mut self, _the_writer: &DdsShared<UserDefinedDataWriter>);
}
...
{
    fn trigger_on_liveliness_lost(&mut self, the_writer: &DdsShared<UserDefinedDataWriter>) {
    ...
    fn trigger_on_publication_matched(&mut self, the_writer: &DdsShared<UserDefinedDataWriter>) {
