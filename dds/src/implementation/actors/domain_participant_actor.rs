...
use crate::{
    ...
    implementation::{
        ...
        rtps::{
            ...
            types::{
                EntityId, Guid, Locator, ReliabilityKind, BUILT_IN_READER_GROUP, BUILT_IN_TOPIC,
    ...
    async fn announce_created_or_modified_data_writer(
            ...
            .await
        {
            ...
            sedp_publications_announcer
                .upgrade()
                .expect("Built-in data writer should exist")
    ...
    async fn process_spdp_participant_discovery(&mut self) {
            ...
            .await
        {
            if let Ok(spdp_data_sample_list) = spdp_participant_reader
                .upgrade()
                .expect("Built-in data reader should exist")
                .read(
                    i32::MAX,
