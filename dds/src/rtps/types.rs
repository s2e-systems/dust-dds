...
#[derive(Clone, Copy, PartialEq, Eq, Debug, CdrDeserialize, XTypesSerialize)]
pub struct Guid {
    prefix: GuidPrefix,
    entity_id: EntityId,
}
...
#[derive(Clone, Copy, PartialEq, Eq, Debug, XTypesSerialize, CdrDeserialize)]
pub struct Locator {
    kind: Long,
    port: UnsignedLong,
    address: [Octet; 16],
...
#[derive(Clone, Copy, PartialEq, Eq, Debug, CdrDeserialize, XTypesSerialize, XTypesDeserialize)]
