...
use crate::types::{Duration, DURATION_INFINITE, DURATION_ZERO, LENGTH_UNLIMITED};
...
const INVALID_QOS_POLICY_ID: QosPolicyId = 0;
const USERDATA_QOS_POLICY_ID: QosPolicyId = 1;
const DURABILITY_QOS_POLICY_ID: QosPolicyId = 2;
const PRESENTATION_QOS_POLICY_ID: QosPolicyId = 3;
const DEADLINE_QOS_POLICY_ID: QosPolicyId = 4;
const LATENCYBUDGET_QOS_POLICY_ID: QosPolicyId = 5;
const OWNERSHIP_QOS_POLICY_ID: QosPolicyId = 6;
const OWNERSHIPSTRENGTH_QOS_POLICY_ID: QosPolicyId = 7;
const LIVELINESS_QOS_POLICY_ID: QosPolicyId = 8;
const TIMEBASEDFILTER_QOS_POLICY_ID: QosPolicyId = 9;
const PARTITION_QOS_POLICY_ID: QosPolicyId = 10;
const RELIABILITY_QOS_POLICY_ID: QosPolicyId = 11;
const DESTINATIONORDER_QOS_POLICY_ID: QosPolicyId = 12;
const HISTORY_QOS_POLICY_ID: QosPolicyId = 13;
const RESOURCELIMITS_QOS_POLICY_ID: QosPolicyId = 14;
const ENTITYFACTORY_QOS_POLICY_ID: QosPolicyId = 15;
const WRITERDATALIFECYCLE_QOS_POLICY_ID: QosPolicyId = 16;
const READERDATALIFECYCLE_QOS_POLICY_ID: QosPolicyId = 17;
const TOPICDATA_QOS_POLICY_ID: QosPolicyId = 18;
const GROUPDATA_QOS_POLICY_ID: QosPolicyId = 19;
const TRANSPORTPRIORITY_QOS_POLICY_ID: QosPolicyId = 20;
const LIFESPAN_QOS_POLICY_ID: QosPolicyId = 21;
const DURABILITYSERVICE_QOS_POLICY_ID: QosPolicyId = 22;
