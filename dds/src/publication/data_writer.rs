...
impl<T> DataWriterImpl<T> {
    ...
    fn set_listener(_this: &Weak<DataWriterImpl<T>>, _a_listener: Box<dyn DataWriterListener<T>>, _mask: &[crate::types::StatusKind]) -> ReturnCode<()> {
        todo!()
    }
    ...
    fn get_statuscondition(_this: &Weak<DataWriterImpl<T>>, ) -> crate::infrastructure::entity::StatusCondition {
        todo!()
    }

    fn get_status_changes(_this: &Weak<DataWriterImpl<T>>,) -> crate::types::StatusKind {
        todo!()
    }
