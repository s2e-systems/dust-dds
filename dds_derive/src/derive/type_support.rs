    ...
    let (get_type_quote, create_dynamic_sample_quote, create_sample_quote) = match &input.data {
                    ...
                    quote! {
                         dust_dds::xtypes::dynamic_type::DynamicTypeMember {
                            descriptor: dust_dds::xtypes::dynamic_type::MemberDescriptor {
                                name: #member_name,
                                id: #member_id,
                                r#type: <#member_type as dust_dds::infrastructure::type_support::Type>::TYPE,
                                default_value: None,
                                index: #index as u32,
        ...
        syn::Data::Enum(xtypes_union) if is_enum_xtypes_union(xtypes_union) => {
            ...
            let union_descriptor = quote! {
                &dust_dds::xtypes::dynamic_type::TypeDescriptor {
                    ...
                    name: #type_name,
                    base_type: None,
                    discriminator_type: ::core::option::Option::Some(<#discriminator_type as ::dust_dds::infrastructure::type_support::Type>::TYPE),
                    bound: None,
                    element_type: None,
                    key_element_type: None,
                    extensibility_kind: #extensibility_kind,
            ...
            let mut variant_list: Vec<TokenStream> = vec![quote! {
                 dust_dds::xtypes::dynamic_type::DynamicTypeMember {
                    descriptor: dust_dds::xtypes::dynamic_type::MemberDescriptor {
                        name: "disc",
                        id: 0u32,
                        r#type: <#discriminator_type as dust_dds::infrastructure::type_support::Type>::TYPE,
                        default_value: None,
                        index: 0u32,
                        try_construct_kind: dust_dds::xtypes::dynamic_type::TryConstructKind::Discard,
                        label: None,
                    ...
                    Fields::Named(fields_named) if fields_named.named.len() == 1 => {
                        ...
                        variant_list.push(quote!{ dust_dds::xtypes::dynamic_type::DynamicTypeMember {
                            descriptor: dust_dds::xtypes::dynamic_type::MemberDescriptor {
                                name: #variant_name,
                                id: #index as u32,
                                r#type: <#variant_ty as dust_dds::infrastructure::type_support::Type>::TYPE,
                                default_value: None,
                                index: #index as u32,
                                try_construct_kind: dust_dds::xtypes::dynamic_type::TryConstructKind::Discard,
                                label: None,
        ...
        syn::Data::Enum(xtypes_enum) => {
            ...
            let discriminator_type = match enum_type_attributes.bit_bound {
                BitBound::I8 => {
                    quote! {<i8 as dust_dds::infrastructure::type_support::Type>::TYPE}
                }
                BitBound::I16 => {
                    quote! {<i16 as dust_dds::infrastructure::type_support::Type>::TYPE}
                }
                BitBound::I32 => {
                    quote! {<i32 as dust_dds::infrastructure::type_support::Type>::TYPE}
                }
            };
