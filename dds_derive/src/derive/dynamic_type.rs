    ...
    match &input.data {
        Data::Struct(data_struct) => {
            ...
            let extinsibility_kind = match extensibility {
                Extensibility::Final => quote! { dust_dds::xtypes::dynamic_type::ExtensibilityKind::Final},
                Extensibility::Appendable => {
                    quote! { dust_dds::xtypes::dynamic_type::ExtensibilityKind::Appendable}
                }
                Extensibility::Mutable => quote! { dust_dds::xtypes::dynamic_type::ExtensibilityKind::Mutable},
            };
            ...
            for (field_index, field) in data_struct.fields.iter().enumerate() {
                ...
                dynamic_type_member.extend(quote! {#field_index => Ok(
                     dust_dds::xtypes::dynamic_type::MemberDescriptor {
                        name: #name,
                        id: 0,
                        default_value: "",
                        index: #field_index,
            ...
            Ok(quote! {
                impl #impl_generics  dust_dds::xtypes::dynamic_type::DynamicType for #ident #type_generics #where_clause {
                    fn get_descriptor(&self) -> Result< dust_dds::xtypes::dynamic_type::TypeDescriptor,  dust_dds::xtypes::error::XTypesError> {
                        Ok( dust_dds::xtypes::dynamic_type::TypeDescriptor {
                    ...
                    fn get_kind(&self) ->  dust_dds::xtypes::dynamic_type::TypeKind {
                         dust_dds::xtypes::dynamic_type::TK_STRUCTURE
                    }
                    ...
                    fn get_member_by_index(&self, index: u32) -> Result<impl  dust_dds::xtypes::dynamic_type::DynamicTypeMember,  dust_dds::xtypes::error::XTypesError> {
                        match index {
                            #dynamic_type_member
                            _ => Err( dust_dds::xtypes::error::XTypesError::InvalidIndex),
                        }
                    }
                }
            })
        ...
        Data::Enum(data_enum) => {
            ...
            Ok(quote! {
                impl #impl_generics  dust_dds::xtypes::dynamic_type::DynamicType for #ident #type_generics #where_clause {
                    ...
                    fn get_kind(&self) ->  dust_dds::xtypes::dynamic_type::TypeKind {
                         dust_dds::xtypes::dynamic_type::TK_ENUM
                    }
...
mod tests {
    ...
    fn xtypes_dynamic_type_struct_with_basic_types() {
        ...
        let expected = syn::parse2::<ItemImpl>(
            "
            impl  dust_dds::xtypes::dynamic_type::DynamicType for MyData {
                fn get_descriptor(&self) -> Result< dust_dds::xtypes::dynamic_type::TypeDescriptor,  dust_dds::xtypes::error::XTypesError> {
                    Ok( dust_dds::xtypes::dynamic_type::TypeDescriptor {
                        kind:  dust_dds::xtypes::dynamic_type::TK_STRUCTURE,
                        name: \"MyData\",
