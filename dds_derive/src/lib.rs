...
#[proc_macro_derive(DdsKey, attributes(key))]
        ...
        match key_fields.is_empty() {
            false => {
                ...
                for key_field in key_fields {
                    ...
                    borrowed_key_holder_fields.extend(quote!{#field_ident: <#field_type as dust_dds::topic_definition::type_support::DdsKey>::BorrowedKeyHolder<'a>,});
                    borrowed_key_holder_field_assignment.extend(quote!{#field_ident: self.#field_ident.get_key(),});

                    owning_key_holder_fields.extend(quote!{#field_ident: <#field_type as dust_dds::topic_definition::type_support::DdsKey>::OwningKeyHolder,});
