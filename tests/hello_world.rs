...
use rust_rtps::{
    dds::domain::domain_participant::DomainParticipant,
    types::{DDSType, Data, InstanceHandle, TopicKind, DURATION_ZERO},
};
...
fn hello_world() {
    ...
    let datawriter = publisher
        .create_datawriter::<HelloWorldType>(&helloworld_topic, Some(data_writer_qos))
