use rust_rtps::types::{DDSType, TopicKind, InstanceHandle, Data};
...
#[test]
fn hello_world() {
    let _participant = DomainParticipantFactory::create_participant(0).expect("Error creating participant");
